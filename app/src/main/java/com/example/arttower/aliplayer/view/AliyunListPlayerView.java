...
public class AliyunListPlayerView extends FrameLayout {
    ...
    private List<HomeBean.DataBean> mVideoListBean;
    private View view;
     ...
     * 设置播放源
     *
     * @param videoListBeanItems
     */
    public void setData(List<HomeBean.DataBean> videoListBeanItems) {
    ...
    private void clearNotShowVideo(List<HomeBean.DataBean> list) {
        Iterator<HomeBean.DataBean> iterator = list.iterator();
 /*     while (iterator.hasNext()) {
            if (iterator.next().getSourceType() == VideoSourceType.TYPE_ERROR_NOT_SHOW) {
                iterator.remove();
           }
        }*/
    }
