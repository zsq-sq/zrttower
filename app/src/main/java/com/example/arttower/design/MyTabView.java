package com.example.arttower.design;
...
public class MyTabView extends LinearLayout {
    ...
    public MyTabView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mColor = ContextCompat.getColor(BaseApplication.getAppContext(), R.color.app_theme_color);
        mTransparent = ContextCompat.getColor(BaseApplication.getAppContext(), R.color.transparent);
        mWhite = ContextCompat.getColor(BaseApplication.getAppContext(), R.color.white);
        mBlackColor = ContextCompat.getColor(BaseApplication.getAppContext(), R.color.black_theme);
        initView();
    }
    ...
    private void initView() {
        ...
        tab1.setBackground(ContextCompat.getDrawable(BaseApplication.getAppContext(),R.drawable.top_tab_shape_left));
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tab3:
                ...
                break;
            case R.id.tab4:
                tab4.setBackground(ContextCompat.getDrawable(BaseApplication.getAppContext(),R.drawable.top_tab_shape_right));
