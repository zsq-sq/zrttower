package com.example.arttower.fragment.MinePage.dialog;
...
public class TakeAlbumDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.camera_photo, container);
        init();
        return inflate;
    }
