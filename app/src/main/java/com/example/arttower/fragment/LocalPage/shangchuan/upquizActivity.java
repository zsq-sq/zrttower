package com.example.arttower.fragment.LocalPage.shangchuan;
...
public class upquizActivity extends AppCompatActivity {
    ...
    // 图片最大数量
    private final static int DEFAULT_NUM = 6;
    ...
    @BindView(R.id.up_teacher_submit)
    Button msubmit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.up_tearcher_quiz);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    ...
                    case 1:// 拍照
                        ...
                        CacheUtils.createImagesCacheFolder(upquizActivity.this);
                        cameraFile = new File(CacheUtils.getCacheImagesFolder(upquizActivity.this).getPath() + "/" + imageName);
                        // 创建好图片文件接收拍照的数据
                        ...
                        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
                            ...
                            cameraUri = FileProvider.getUriForFile(upquizActivity.this, "com.wong.camera.fileprovider", cameraFile);
                        } else {
    ...
    static class ActivityViewHolder {
        ...
        public ActivityViewHolder(Window window) {
         // mRV = window.findViewById(R.id.rlvimage);
